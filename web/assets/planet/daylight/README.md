...
The terrain and flowers are authored in `web/wander-world.js`. High quality uses 16,000 instanced flowers and a directional shadow map; light quality uses 8,000 flowers and the character's contact shadow. The in-app settings offer automatic, rich and light quality.
